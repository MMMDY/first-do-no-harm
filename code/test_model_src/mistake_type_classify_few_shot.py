...
class Critic_Type_Classify:
    ...
    def get_prediction(self, system_prompt: str, history: str, enable_thinking: bool) -> str:
        """
        发送单个请求并返回模型的响应。
        """
        messages = []
    ...
    def generate_predictions(self, input_file: str, output_file: str, max_workers: int, num_samples: int = None, enable_thinking: bool = False):
        """
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            future_to_item = {
                executor.submit(self.get_prediction, item.get("instruction", ""), item.get("history", ""), enable_thinking): item
                for item in data
            }
...
def run(max_workers: int = 50, num_samples: int = None):
    ...
    prompt_template_path = "/WX24061/lzy/test_model/mistake_classify_prompt_fewshot2.txt" # /WX24061/models/qwen3-14b
    ...
    predictions_output_dir = "/WX24061/lzy/test_model/mistake_classify_fewshot/"
    #predictions_output_dir= "/WX24061/lzy/test_model/mistake_classify_grpo/"
    predictions_output_file = predictions_output_dir + "qwen3-14b-fewshot2-think.json"
    ...
    generator.generate_predictions(input_file, predictions_output_file, max_workers, num_samples,enable_thinking)
...
if __name__ == "__main__":
   ...
   # CUDA_VISIBLE_DEVICES=2 vllm serve /WX24061/lzy/Models/qwen3-8b-instruct --gpu-memory-utilization 0.8
...
# CUDA_VISIBLE_DEVICES=1 vllm serve /WX24061/lzy/models/qwen3-14b
...
# CUDA_VISIBLE_DEVICES=1 vllm serve /WX24061/lzy/Models/llama3.1-8b-instruct --gpu-memory-utilization 0.8
# CUDA_VISIBLE_DEVICES=1 vllm serve /WX24061/lzy/Models/qwen3-8b-instruct