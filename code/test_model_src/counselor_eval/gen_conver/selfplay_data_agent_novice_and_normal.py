...
class MakeData:
    def __init__(self, model_type="api", model_name=None, api_base=None, api_key=None, 
        ...
        self.paths = {
            'output_path': output_data_path or '/WX24061/lzy/test_model/counselor_eval/gen_conver/output_data/normal/normal_1.jsonl',
            ...
            # "counselor_prompt_path": '/WX24061/lzy/test_model/counselor_eval/gen_conver/prompt/counselor_prompt.txt',
            "counselor_prompt_path": '/WX24061/lzy/test_model/counselor_eval/gen_conver/prompt/normal_counselor_prompt.txt',
        ...
        for i in range(0, len(tasks), self.max_concurrent):
            ...
            if batch_results:
                for item in batch_results:
                    self.save_chat_history(item["uuid"], item["patient_id"], item["mistake_id"], item["chat_history"], item["history_string"], item["critic_content"], item["critic_reasoning"],item["mistake_classify_result"])
                batch_results.clear()
        pbar.close()
